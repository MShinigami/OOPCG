...
void display()
{
    ...
    {
        drawstring(GLUT_BITMAP_HELVETICA_18, "player 2's turn (circle)", 100, 30);
    }
    drawlines();
    drawxo();
    if (checkifwin())
    ...
    if (gameover)
    {
        drawstring(GLUT_BITMAP_HELVETICA_18, "GAME OVER", 90, 360);
        if (result == 0)
        {
            drawstring(GLUT_BITMAP_HELVETICA_18, "Draw", 100, 480);
        }
        if (result == 1)
        {
            drawstring(GLUT_BITMAP_HELVETICA_18, "PLAYER 1 WIN", 80, 480);
        }
        if (result == 2)
        {
            drawstring(GLUT_BITMAP_HELVETICA_18, "PLAYER 2 WIN", 80, 480);
        }
        drawstring(GLUT_BITMAP_HELVETICA_18, "DO YOU WANT TO CONTINUE (Y/N)", 10, 510);
    }
    glutSwapBuffers();
}
